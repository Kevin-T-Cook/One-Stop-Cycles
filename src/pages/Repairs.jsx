...
const Reparis = () => {
  return (
    <div>
        ...
        <h1 className='repairsTitle'>Service & Repairs</h1>
          <div className="repairPhoto">
              <img className="repairImage" src="https://www.sefiles.net/images/library/site/se-lib-lp-hero-careers.jpg" alt="hand reaching for bike tools" />
          </div>
        <div className='serviceContainer'>
              <div className='serviceHeader'>
                  <h1>Services We Provide</h1>
                  <p>This is an overview of the services we provide. If you don't see something below, come on in and we will take care of your of your bike needs.</p>
              </div>
              <div className='services'>
                  <div className="tuneUps">
                  ...
                  <div className="installations">
                      ...
                      <h3>Part/Accessories Installation</h3>
                  </div>
                  <div className="tires">
